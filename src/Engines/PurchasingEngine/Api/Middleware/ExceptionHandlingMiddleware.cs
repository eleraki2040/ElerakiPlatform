...
namespace Eleraki.PurchasingEngine.Api.Middleware;
...
public class ExceptionHandlingMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        catch (Exception ex)
        {
            ...
            {
                await context.Response.WriteAsync(JsonSerializer.Serialize(new { message = ex.Message, detail = ex.StackTrace }));
            }
            else
            {
